...
class bb(Strategy): # 独自の売買戦略
    ...
    def next(self):
        if crossover(self.b_lower, self.data["Close"]) or crossover(self.macd, self.macdsignal):     # -2σ > 終値 で買う
